...
class MockSpiAdapter extends SpiAdapter {
  ...
  async poll() {
    ...
    return {
      ...
      defects: { bridge: Math.floor(this._ng*0.3), insufficient: Math.floor(this._ng*0.25), excess: Math.floor(this._ng*0.2), shift: Math.floor(this._ng*0.15), tombstone: Math.floor(this._ng*0.1) },
      timestamp: new Date().toISOString(),
    };
  }
}
module.exports = { MockSpiAdapter };
